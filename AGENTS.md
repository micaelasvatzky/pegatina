...
- 🔲 Fotos reales de stickers con **Cloudinary** (Mica YA tiene la carpeta local lista; falta que cree la cuenta y me pase credenciales → script de upload+mapeo → reemplaza al input URL del form)
